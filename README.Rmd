...
9. `nregtestrel`: a function that computes various non-regression-based measures of deviation between the vector of _relative_ prices of production and the vector of _relative_ labor values;

10. `regtestrel`: a function that computes various regression-based measures of deviation between the vector of _relative_ prices of production and the vector of _relative_ labor values;
