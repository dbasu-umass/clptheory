...
1. `ppstdint1`: a function to estimate a basic circulating capital model with the Standard Interpretation;

4. `ppnewint1`: a function to estimate a basic circulating capital model with the New Interpretation;
