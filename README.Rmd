...
si2$dp
```
These are different from what is reported in equation (12) on page 48 in Ochoa (1984). The reason for this difference is that he uses a vector of market prices, `(4, 60, 7)` for normalization that is different from a vector of 1s (which is the common assumption in real world analysis). To use this vector of market prices, we can do the following:
```{r}
